...
export async function createStudent({ name, dob, belt, stripes, membershipStart, membershipEnd, amountPaid }) {
...
export async function updateStudent(id, { name, dob, belt, stripes, membershipStart, membershipEnd }) {
